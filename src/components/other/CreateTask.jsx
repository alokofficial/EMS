...
const CreateTask = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    setNewTask({taskTitle,taskDescription,taskDate,category,active:false,failed:false,completed:false,newTask:true})
    const data = userData
    data.forEach((emp) => {
  ...
  return (
    <div className="p-5 mt-7 rounded bg-[#36353545]">
      <form onSubmit={(e) => submitHandler(e)} className="flex flex-wrap items-start justify-between w-full">
        ...
        <div className="w-1/2 felx felx-col items-start">
